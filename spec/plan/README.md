...
|-----------|-------------|---------|------|
| [M1](milestone-1-foundation.md) | Foundation & Instance Registry | S-1.0 through S-1.4 | `milestone-1-foundation.md` |
| [M2](milestone-2-invocation.md) | Agent Invocation & Streaming | S-2.0 through S-2.3 | `milestone-2-invocation.md` |
| [M3](milestone-3-management-ui.md) | Management UI | S-3.0 through S-3.2 | `milestone-3-management-ui.md` |
